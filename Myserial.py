...
# Grid layout - configuración simétrica
# Fila 0: Título (todo el ancho)
# Fila 1: Gráficas y botones (50% izq + 50% der)
# Fila 2: Input box (todo el ancho)
# Fila 3: Gráfica 3D (75%) + Instrucciones (25%)

window.rowconfigure(0, weight=0, minsize=80)  # Título
window.rowconfigure(1, weight=0, minsize=280)  # Gráficas de arriba
window.rowconfigure(2, weight=0, minsize=60)  # Input box
window.rowconfigure(3, weight=1)  # Gráfica 3D e instrucciones (expandible)
...
# Mitad izquierda (Botones + Gráfica temperatura)
frame_izquierda = Frame(window, bg="white")
frame_izquierda.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")
frame_izquierda.columnconfigure(0, weight=0, minsize=160)
frame_izquierda.columnconfigure(1, weight=1)
...
# Mitad derecha (Gráfica radar + Botones)
frame_derecha = Frame(window, bg="white")
...
frame_botones_dos = Frame(frame_derecha, bg="lightpink", bd=2)
...
row2frame.columnconfigure(2, weight=0, minsize=160)

Texto = Entry(row2frame, textvariable=input_user, width=60, font=("Microsoft YaHei", 12), fg="grey")
Texto.grid(row=0, column=1, padx=10, pady=5, sticky="ew", ipady=8)
...
frame_info.grid(row=3, column=1, padx=10, pady=10, sticky="nsew")
